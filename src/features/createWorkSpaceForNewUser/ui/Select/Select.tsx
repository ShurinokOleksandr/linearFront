...
import { ValidationCreateWorkSpaceFormType } from '../CreateWorkSpaceForm';
...
export const Select = ({ children,setValue,field }:SelectCompanySizeType) => {
    ...
    return (
        <>
            <Box ref={refs.setReference}>
                ...
                >
                    <Span>
                        {selectedLabel ?? 'Selected value test'}
                    </Span>

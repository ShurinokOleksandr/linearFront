import { externalApi } from '@/shared/utils/api';
    ...
    .actions((self) => ({
        async submitSignUp() {
            if (
                ...
                self.username &&
                self.password === self.repeatPassword
            ) {
        ...
        setPassword(password: string) {
            ...
            if (
                self.password.length === self.repeatPassword.length &&
                self.password === self.repeatPassword
            ) {
                this.setRepeatPasswordValidationError('');
            }
...
//
// }
// export const signUpStore = new SignUpStore(user-store);

import { CommonProps, KebabKeys } from '@/shared/ui/Common-props/CommonProps';
...
export const DefaultButton = styled(CommonProps)
    ...
    font-size:  ${({ fontSize, theme }) =>
        fontSize ? fontSize : theme.fontSizes.small};
    cursor: ${({ cursor }) => (cursor ? cursor : 'pointer')};
    &:hover {
        background: ${({ background, theme }) =>
        background ? background : theme.gray950
};
    ...
    ${(props) =>
        ...
        ? props._hover.color
        : props.theme.color1};
                    background: ${props?._hover?.background
        ? props._hover.background
        : props.theme.surface2};
                }
            `}
    ${(props) =>

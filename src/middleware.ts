...
export async function middleware(request: NextRequest) {
	...
	const pathToAllPages = request.nextUrl.pathname === '/' ||   request.nextUrl.pathname === '/main' || dynamicPathRegex.test(request.nextUrl.pathname);
	if (!access_token && !refresh_token && pathToAllPages) {
